package me.synology.hsbong.patientphotostorage.sign;
...
import me.synology.hsbong.patientphotostorage.EtcLib;
...
public class SignupFragment extends Fragment {
    ...
    EditText _uploadImageButton;
    @BindView(R.id.imageUploadView)
    EditText _uploadImageView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(ContextCompat.checkSelfPermission(getContext(), Manifest.permission.READ_PHONE_STATE ) == PackageManager.PERMISSION_GRANTED) {
            String phone = EtcLib.getInstance().getPhoneNumber(getContext());
